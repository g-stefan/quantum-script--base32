...
#define QUANTUM_SCRIPT_EXTENSION_BASE32_LICENSE_HPP
...
namespace Quantum {
	namespace Script {
		namespace Extension {
			namespace Base32 {
				namespace License {
					QUANTUM_SCRIPT_EXTENSION_BASE32_EXPORT const char *content();
					QUANTUM_SCRIPT_EXTENSION_BASE32_EXPORT const char *shortContent();
				};
			};
		};
	};
